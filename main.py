...
def get_args():
    ...
    parser.add_argument('--dico-method', type=str, default='csls_knn_10')
    parser.add_argument('--dico-max-rank', type=int, default=15000)
    parser.add_argument('--dico-build', type=str, default='S2T&T2S')
